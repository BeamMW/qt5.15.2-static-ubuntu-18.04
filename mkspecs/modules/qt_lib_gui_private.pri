...
QT.gui_private.enabled_features = xkbcommon xkbcommon-x11 xcb drm_atomic evdev freetype system-freetype fontconfig gif harfbuzz ico imageio-text-loading jpeg kms linuxfb multiprocess png raster-64bit system-harfbuzz system-xcb-xinput tuiotouch vkgen vnc xlib xcb-xlib xcb-glx-plugin xcb-glx xcb-sm
